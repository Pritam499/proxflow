...
import (
	...
	"github.com/Pritam499/proxflow/v2/modules/caddyhttp/encode"
)
...
func (fsrv *FileServer) ServeHTTP(w http.ResponseWriter, r *http.Request, next caddyhttp.Handler) error {
	...
	// in HTML (see https://github.com/Pritam499/proxflow/issues/2741)
	if fsrv.CanonicalURIs == nil || *fsrv.CanonicalURIs {
		...
		// See https://github.com/Pritam499/proxflow/issues/4205.
	...
	for _, ae := range encode.AcceptedEncodings(r, fsrv.PrecompressedOrder) {
		...
		// see: https://github.com/Pritam499/proxflow/issues/7040
		// Setting the Range header manually will result in 206 Partial Content.
		// see: https://github.com/Pritam499/proxflow/issues/7250
