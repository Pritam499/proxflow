...
// see: https://github.com/Pritam499/proxflow/issues/6678#issuecomment-2472224182
...
// php-fpm will hang if there is any data in the body though, https://github.com/Pritam499/proxflow/issues/5420#issuecomment-2415943516
...
func (t Transport) buildEnv(r *http.Request) (envVars, error) {
	...
	// See https://github.com/Pritam499/proxflow/issues/3718
	if pathInfo == "" {
