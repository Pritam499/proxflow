...
func (h *Handler) handleUpgradeResponse(logger *zap.Logger, wg *sync.WaitGroup, rw http.ResponseWriter, req *http.Request, res *http.Response) {
	...
	// see: https://github.com/Pritam499/proxflow/issues/6273
	...
	// see: https://github.com/Pritam499/proxflow/issues/7418
...
//
// See https://github.com/Pritam499/proxflow/pull/3620 for discussion of nuances.
func (h Handler) isBidirectionalStream(req *http.Request, res *http.Response) bool {
	...
	// (see https://github.com/Pritam499/proxflow/issues/3606 for use case)
